insert into person(id, firstName, lastName, birthDate, street, number, postalCode, city, version) values(1000, 'John', 'Doe', '1970-01-01', 'Brighton Road', '27', '1000', 'Brussels', 1);
insert into person(id, firstName, lastName, birthDate, street, number, postalCode, city, version) values(2000, 'Jane', 'Doe', '1970-01-02', 'Harper Lane', '8', '2845', 'London', 1);
insert into person(id, firstName, lastName, birthDate, street, number, postalCode, city, version) values(3000, 'Tyler', 'Turner', '1983-07-15', 'Masonstreet', '72B', '5874', 'Winterfell', 1);
insert into person(id, firstName, lastName, birthDate, street, number, postalCode, city, version) values(4000, 'Marcia', 'Jackson', '1975-03-28', 'Factory Lane', '100/7', '1578', 'Glasgow', 1);
insert into person(id, firstName, lastName, birthDate, street, number, postalCode, city, version) values(5000, 'Allan', 'Wilson', '1964-12-28', 'Turingstreet', '1', '2547', 'Newcastle', 1);
...
insert into candy(id, name, color, price, candy_type, version) values(1000, 'Jolly Ranger M&Ms', 'RED', 4.95, 'm&m', 1);
insert into candy(id, name, color, price, candy_type, version) values(2000, 'Pink Kisses', 'PINK', 3.99, 'm&m', 1);
insert into candy(id, name, color, price, candy_type, version) values(3000, 'Jumbo Gummy Bears', 'BLUE', 3.24, 'gummy', 1);
insert into candy(id, name, color, price, candy_type, version) values(4000, 'Roaring Gummy Bears', 'VIOLET', 7.98, 'gummy', 1);
insert into candy(id, name, color, price, candy_type, version) values(5000, 'Ultra Long Mega Bars', 'WHITE', 6.99, 'chocolate', 1);
insert into candy(id, name, color, price, candy_type, version) values(6000, 'Sweethearts', 'BROWN', 3.74, 'chocolate', 1);
